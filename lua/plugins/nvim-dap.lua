return {
  ...
  keys = {
    ...
    { "<leader>de", function() require("dapui").eval() end, desc = "Eval <F2>", mode = {"n", "v"} },
    { "<F2>", function() require("dapui").eval() end, desc = "Eval", mode = {"n", "v"} },
  },
      opts = {},
  ...
  keys = {
    ...
    { "<leader>db", function() require("dap").toggle_breakpoint() end, desc = "Toggle Breakpoint <F3>" },
    ...
    { "<leader>dl", function() require("dap").run_last() end, desc = "Run Last <F5>" },
    { "<F5>", function() require("dap").run_last() end, desc = "Run Last" },
    { "<leader>do", function() require("dap").step_out() end, desc = "Step Out <F6>" },
